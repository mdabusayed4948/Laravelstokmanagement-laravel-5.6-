...
<div class="box box-default">
 ...
 {{ Form::open(array('route' => 'brands.store','class' => 'form-horizontal','id' => 'createscoreForm')) }}
 ...
 <div class="box-body">
  ...
  <div class="box-footer text-center">
   <a href="{{ route('brands.index') }}" class="btn btn-primary btn-sm"><i class="fa fa-arrow-circle-left"></i> Back</a> 
    ...
    arrayNumber = Number(arrayNumber) + 1;   
      ...
      var tr = '<tr id="row'+count+'" class="'+arrayNumber+'">'+                
        '<td>'+
          ...
          '<input type="text" name="name[]" placeholder="Brand Name"  autocomplete="off"  class="form-control"  /> '+
         '</td>'+
