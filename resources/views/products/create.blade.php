      ...
      <!-- /.box-header -->
       ...
       <div class="box-body">
         <div class="form-group">
          ...
          <div class="form-group">
            <label for="brands" class="col-sm-3 control-label">Category Name :</label>
   ...
   <div class="col-md-4">
     <div class="box box-primary">
      ...
      <div class="box-footer text-center">
        <a href="{{ route('brands.index') }}" class="btn btn-default button1"> <i class="fa fa-arrow-circle-left"></i> Back </a>
...
<script src="{{ asset('public/bower_components/select2/dist/js/select2.full.min.js') }}"></script>
 ...
 <script type="text/javascript">
    ...
    $("#productImage").fileinput({
        ...
        defaultPreviewContent: '<img src="{{ asset('public/default/photo_default.png') }}" alt="Profile Image" style="width:100%;">',
